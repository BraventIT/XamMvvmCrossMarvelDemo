...
using ObjCRuntime;
using UIKit;
using XamMvvmCrossMarvelDemo.iOS.Controls;
using XamMvvmCrossMarvelDemo.iOS.Tables;
using XamMvvmCrossMarvelDemo.Core.ViewModels;

namespace XamMvvmCrossMarvelDemo.iOS.Views
{
    [Register("FirstView")]
    public class FirstView : MvxViewController
    {
		...
		{
			// TODO: 7. Set the Binding of the FirstView
